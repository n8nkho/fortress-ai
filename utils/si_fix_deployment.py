...
_GUARD_SOURCES: dict[str, list[Path]] = {
    ...
    "market_relative_underperformance": [
        ...
        _ROOT / "config" / "guards.py",
        _ROOT / "guards" / "__init__.py",
        _ROOT / "guards" / "market_relative_guard.py",
        _ROOT / "portfolio" / "session_monitor.py",
        ...
        _ROOT / "utils" / "portfolio_session" / "pre_trade_gate.py",
        ...
        _ROOT / "deploy" / "trading-bot-patches" / "src" / "portfolio_session" / "entry_blocks.py",
        ...
        _ROOT / "deploy" / "trading-bot-patches" / "fortress_ai" / "__init__.py",
        _ROOT / "deploy" / "trading-bot-patches" / "fortress_ai" / "portfolio_session.py",
        _ROOT / "deploy" / "trading-bot-patches" / "fortress_ai" / "guards" / "__init__.py",
        _ROOT / "deploy" / "trading-bot-patches" / "fortress_ai" / "guards" / "market_relative_guard.py",
        _ROOT / "deploy" / "trading-bot-patches" / "tests" / "test_fortress_ai_portfolio_session.py",
        _ROOT / "tests" / "test_fortress_ai_portfolio_session.py",
    ...
    "market_participation_gap": [
        _ROOT / "utils" / "portfolio_session" / "constructive_tape_override.py",
        _ROOT / "utils" / "portfolio_session" / "pre_trade_gate.py",
        _ROOT / "utils" / "portfolio_session" / "gates" / "market_relative_underperformance_gate.py",
        _ROOT / "utils" / "portfolio_session" / "guards" / "market_relative_underperformance.py",
        _ROOT / "utils" / "portfolio_session" / "session_state.py",
        _ROOT / "utils" / "consciousness_posture.py",
        _ROOT / "utils" / "market_consciousness.py",
        _ROOT / "utils" / "market_benchmark.py",
        _ROOT / "utils" / "si_capability_review.py",
        _ROOT / "config" / "si_fix_registry.json",
        _ROOT / "tests" / "test_constructive_tape_override.py",
        _ROOT / "tests" / "test_consciousness_posture.py",
    ],
    ...
    "edge_autofix_exhausted": [
        ...
        _ROOT / "tests" / "test_si_true_loop.py",
    ],
