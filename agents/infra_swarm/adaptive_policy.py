...
from agents.infra_swarm.symbol_causation import ensure_causation
...
def _adapt_to_winning_pattern_share(
    ...
    from agents.infra_swarm.intraday_si import session_expectancy_ok
...
def apply_adaptations(
    ...
    *,
    ...
    from agents.infra_swarm.intraday_si import adapt_from_block_streaks, adapt_session_overlay
...
def reset_session_adaptive_state(learned: dict[str, Any]) -> None:
    ...
    from agents.infra_swarm.intraday_si import reset_intraday_session_state
